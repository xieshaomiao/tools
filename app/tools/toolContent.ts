...
const englishToolCopy: Record<string, EnglishToolCopy> = {
  'pdf-convert': { title: 'Universal Document Converter', description: 'Convert between PDF, Word, Excel, PowerPoint, TXT, Markdown, HTML and common image formats directly in your browser.', badge: 'File Tool', category: 'File Tools', placeholder: 'Choose a source file and an output format, then download the converted file or copy its preview.', example: 'Convert a DOCX proposal to PDF, or extract a PDF into Word, Excel, PowerPoint, TXT, HTML or page images.', keywords: ['document converter', 'PDF converter', 'Word to PDF', 'PDF to Word'] },
